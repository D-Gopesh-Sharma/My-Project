...
PROJECT_DIR = Path(__file__).absolute().parents[1].absolute()
...
VAE_PATH = f'{PROJECT_DIR}/checkpoints/ootd'
UNET_PATH = f'{PROJECT_DIR}/checkpoints/ootd/ootd_hd/checkpoint-36000'
MODEL_PATH = f'{PROJECT_DIR}/checkpoints/ootd'
